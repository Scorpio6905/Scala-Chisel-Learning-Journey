error id: file://<WORKSPACE>/src/main/scala/Gates/Mux8to1.scala:
file://<WORKSPACE>/src/main/scala/Gates/Mux8to1.scala
...
non-local guesses:
	 -chisel3/Mux2to1#
	 -Mux2to1#
	 -scala/Predef.Mux2to1#
offset: 1133
uri: file://<WORKSPACE>/src/main/scala/Gates/Mux8to1.scala
text:
```scala
package Gates
import chisel3._
