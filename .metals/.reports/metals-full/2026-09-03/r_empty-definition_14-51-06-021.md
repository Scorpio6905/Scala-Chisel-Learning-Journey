error id: file://<WORKSPACE>/src/test/scala/regfile/regfiletest.scala:regfile/regfiletest#`<error: <none>>`#
...
class regfiletest extends FreeSpe@@c with ChiselScalatestTester{
    "Register Test" in {
