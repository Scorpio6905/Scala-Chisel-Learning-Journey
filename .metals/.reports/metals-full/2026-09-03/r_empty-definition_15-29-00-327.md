error id: file://<WORKSPACE>/src/main/scala/regfile/memory.scala:regfile/Asynch_Mem#memory.
file://<WORKSPACE>/src/main/scala/regfile/memory.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol regfile/Asynch_Mem#memory.
empty definition using fallback
non-local guesses:

offset: 477
uri: file://<WORKSPACE>/src/main/scala/regfile/memory.scala
text:
```scala
package regfile
